...
export default function Card() {
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16  relative flex flex-col lg:flex-row items-center justify-between text-center lg:text-left">
        <div className="lg:w-1/2 order-2 lg:order-1">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">
                Selamat datang di web inventaris
            </h1>
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-0">
                At our Inventory System, we leverage technology, innovation, and capital to unlock long-term value and drive economic growth.
            </p>
        </div>
        <div className="lg:w-1/2 order-1 lg:order-2">
            <img src="./public/data.jpg" className="mx-auto lg:mx-0" alt="Flowbite Logo" />
        </div>
    </div>
</section>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <Link to={'/stuffs'}  class="flex items-center">
                  <img src="./public/dataLogo.png" class="h-8 me-3" alt="FlowBite Logo" />
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Inventaris</a>
                      </li>
                      <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link to={'/stuffs'} class="hover:underline">Inventaris</Link>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <Link href="" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                  <svg class="w-4 h-4" aria-hidden="true" xmlns="https://github.com/marsyaanandadewi" fill="currentColor" viewBox="0 0 20 20">
